...
export default function AboutPage() {
  return (
    <div className="h-full bg-[#C8E6C9] flex flex-col">
      ...
      {/* opcional: só uma linha no fim (sem faixa branca) */}
      <div className="mt-auto border-t border-primary/20 bg-transparent" />
    </div>
  );
}
