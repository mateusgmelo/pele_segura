      ...
      <div className="flex-1 px-6 pb-6 overflow-y-auto flex flex-col gap-4">
        <div className="bg-[#E8F5E9] rounded-3xl p-6 shadow-sm flex-1 mb-8">
          <p className="text-primary text-sm font-medium leading-relaxed text-center">
            São lesões ou feridas causadas pela falta de mudança de posição do paciente ou dificuldade de se locomover.
          </p>
          
          <div className="mt-8 rounded-2xl overflow-hidden border-4 border-white shadow-sm mx-auto w-48 h-48 bg-gray-200">
            <img 
              src="https://images.unsplash.com/photo-1516574187841-693083f69b29?auto=format&fit=crop&q=80&w=400" 
