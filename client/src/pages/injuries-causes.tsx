    ...
    <div className="flex flex-col h-full bg-[#C8E6C9]">
      ...
      <div className="flex-1 px-6 pb-6 overflow-y-auto flex flex-col gap-4">
        <div className="bg-[#E8F5E9] rounded-3xl p-6 shadow-sm flex-1 mb-8">
          <h3 className="text-primary font-bold text-sm mb-2">Pressão</h3>
          <p className="text-primary text-sm font-medium leading-relaxed text-justify">
            Pessoas com mobilidade reduzida têm mais chances de desenvolver lesões por pressão, devido à falta de movimentação e a pressão constante em certas áreas do corpo.
          </p>
          
          <div className="mt-6 rounded-2xl overflow-hidden border-4 border-white shadow-sm mx-auto w-48 h-40 bg-gray-200">
             <img 
              src="https://images.unsplash.com/photo-1530026186672-2cd00ffc4520?auto=format&fit=crop&q=80&w=400" 
